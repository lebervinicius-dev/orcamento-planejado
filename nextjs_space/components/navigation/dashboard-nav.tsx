...
export function DashboardNav() {
  ...
  const navigation = [
    ...
    { 
      ...
      icon: Tags,
      tooltip: 'Organize suas transações por categorias' 
    },
    { 
      name: 'Análises IA', 
      href: '/dashboard/analyses', 
      icon: Brain,
      tooltip: 'Insights inteligentes com Sofia' 
    },
    ...(isAdmin ? [{ 
      name: 'Admin', 
    ...
    <>
      <nav className="bg-[#0d0d0d] border-b border-[#2a2a2a] sticky top-0 z-50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4">
                      ...
                      <TooltipTrigger asChild>
                        <Link
                          ...
                          className={`flex items-center space-x-2 px-3 py-2 rounded-lg font-medium transition-all ${
                            isActive
                              ? 'bg-[#00bf63] text-white shadow-lg shadow-[#00bf63]/30'
                              : 'text-[#b0b0b0] hover:text-[#00bf63] hover:bg-[#00bf63]/10 hover:scale-105'
                          }`}
                        >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className="flex items-center space-x-2 text-[#b0b0b0] hover:text-[#00bf63] transition-all px-3 py-2 rounded-lg hover:bg-[#00bf63]/10 hover:scale-105"
                    >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className="flex items-center space-x-2 text-[#b0b0b0] hover:text-red-500 transition-all px-3 py-2 rounded-lg hover:bg-red-500/10 hover:scale-105"
                    >
          ...
          {/* Mobile Navigation */}
          {isMobileMenuOpen && (
            <div className="md:hidden border-t border-[#2a2a2a] py-4 animate-fade-in-up">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-xs text-[#737373]">{item.tooltip}</span>
                      </div>
                    </Link>
                  )
                })}
